...
#ifndef VERILATED_VICACHECONTROLLER___024ROOT_H_
#define VERILATED_VICACHECONTROLLER___024ROOT_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
class VIcachecontroller___024unit;


class VIcachecontroller__Syms;

class alignas(VL_CACHE_LINE_BYTES) VIcachecontroller___024root final : public VerilatedModule {
  public:
    // CELLS
    VIcachecontroller___024unit* __PVT____024unit;
    ...
    struct {
        ...
        VL_IN8(rst,0,0);
        VL_IN8(access_way,1,0);
        VL_IN8(set_idx,3,0);
        VL_IN8(update,0,0);
        VL_IN8(valid_ways,3,0);
        VL_OUT8(victim_way,1,0);
        VL_IN8(MemWrite,0,0);
        VL_IN8(MemRead,0,0);
        ...
        CData/*0:0*/ pipelinedCpuTest__DOT__dut__DOT__IFflush;
        ...
        CData/*3:0*/ pipelinedCpuTest__DOT__dut__DOT__EXEX;
        ...
        SData/*8:0*/ pipelinedCpuTest__DOT__dut__DOT__finalCRLTID;
        VL_IN(address,31,0);
    };
    struct {
        VL_IN(Write_data,31,0);
        VL_OUT(Read_data,31,0);
        IData/*31:0*/ BPLRU__DOT__unnamedblk2__DOT__i;
        IData/*31:0*/ pipelinedCpuTest__DOT__dut__DOT__nextPc;
        IData/*31:0*/ pipelinedCpuTest__DOT__dut__DOT__pcPlus4IF;
        IData/*31:0*/ pipelinedCpuTest__DOT__dut__DOT__regData1ID;
        IData/*31:0*/ pipelinedCpuTest__DOT__dut__DOT__regData2ID;
        ...
        VlUnpacked<CData/*3:0*/, 16> BPLRU__DOT__lru_bits;
        VlUnpacked<IData/*31:0*/, 256> Memory__DOT__memory;
    ...
    // CONSTRUCTORS
    VIcachecontroller___024root(VIcachecontroller__Syms* symsp, const char* v__name);
    ~VIcachecontroller___024root();
    VL_UNCOPYABLE(VIcachecontroller___024root);
