...
void VpipelinedCpuTest___024root___eval_triggers__act(VpipelinedCpuTest___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->pipelinedCpuTest__DOT__clk) 
...
extern const VlUnpacked<CData/*0:0*/, 128> VpipelinedCpuTest__ConstPool__TABLE_ha69390be_0;
extern const VlUnpacked<CData/*0:0*/, 128> VpipelinedCpuTest__ConstPool__TABLE_h99f9b8cb_0;
...
VL_INLINE_OPT void VpipelinedCpuTest___024root___nba_sequent__TOP__0(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___nba_sequent__TOP__0\n"); );
    // Init
    ...
    if (VL_UNLIKELY(vlSelf->pipelinedCpuTest__DOT__dut__DOT__pcSrcEX)) {
        VL_WRITEF("BRANCH TAKEN: PC=%x -> Target=%x\n",
                  32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__PC__DOT__PCRegister,
                  32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__branchTargetEX);
    }
    if (VL_UNLIKELY(vlSelf->pipelinedCpuTest__DOT__dut__DOT__IFflushEX)) {
        VL_WRITEF("PIPELINE FLUSHED by branch\n");
    }
    ...
    if (VL_UNLIKELY(((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__IFIDwrite) 
                     & (0U != vlSelf->pipelinedCpuTest__DOT__dut__DOT__instID)))) {
        VL_WRITEF("T=%0t | [ID ] instID=%x\n",64,VL_TIME_UNITED_Q(1000),
                  -9,32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__instID);
    }
    if (VL_UNLIKELY(((0U != (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__WBEX)) 
                     | (0U != (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__MEMEX))))) {
        VL_WRITEF("T=%0t | [EX ] WBEX=%b MEMEX=%b AluRes=%x WrtReg=%0#\n",
                  64,VL_TIME_UNITED_Q(1000),-9,2,(IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__WBEX),
                  3,vlSelf->pipelinedCpuTest__DOT__dut__DOT__MEMEX,
                  32,((8U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                       ? ((4U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                           ...
                           : ((2U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                               ? 0U : ((1U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                                        ? 0U : VL_SHIFTL_III(32,32,32, vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluInb, 0x10U))))
                       : ((4U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                           ? ((2U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
    ...
    if (VL_UNLIKELY((((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__WBWB) 
                      >> 1U) & (0U != (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__writeRegWB))))) {
        VL_WRITEF("T=%0t | [WB ] Writing reg[%0#] = %x\n",
                  64,VL_TIME_UNITED_Q(1000),-9,5,(IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__writeRegWB),
                  32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__finalResultWB);
    }
    if (VL_UNLIKELY((0ULL == VL_MODDIV_QQQ(64, (QData)(VL_TIME_UNITED_Q(1000)), 0x3e8ULL)))) {
        VL_WRITEF("T=%0t | REGS: $at=%x $v0=%x $s0=%x $s1=%x $s2=%x\n",
                  64,VL_TIME_UNITED_Q(1000),-9,32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__Reg_Files_instance__DOT__Register
                  [1U],32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__Reg_Files_instance__DOT__Register
                  [2U],32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__Reg_Files_instance__DOT__Register
                  [0x10U],32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__Reg_Files_instance__DOT__Register
                  [0x11U],32,vlSelf->pipelinedCpuTest__DOT__dut__DOT__Reg_Files_instance__DOT__Register
                  [0x12U]);
    }
    ...
    if (((IData)(vlSelf->pipelinedCpuTest__DOT__rst) 
         | (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__IFflushEX))) {
    ...
    __Vtableidx1 = (((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_stall) 
                     << 6U) | (((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__ic_stall) 
                                << 5U) | (((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__MEMMEM) 
                                           << 2U) | 
                                          (((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_ready) 
                                            << 1U) 
                                           | (IData)(vlSelf->pipelinedCpuTest__DOT__rst)))));
    if (VpipelinedCpuTest__ConstPool__TABLE_ha69390be_0
        [__Vtableidx1]) {
        vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_done 
            = VpipelinedCpuTest__ConstPool__TABLE_h99f9b8cb_0
            [__Vtableidx1];
    }
    ...
    if (vlSelf->pipelinedCpuTest__DOT__rst) {
        ...
        if ((2U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__WBWB))) {
        ...
        if ((1U & ((~ (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_stall)) 
                   & (~ (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__ic_stall))))) {
        ...
        if (((0U == (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__D_CACHE__DOT__ctrl__DOT__state)) 
             & ((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT____Vcellinp__D_CACHE__cpu_read) 
    ...
    if (vlSelf->pipelinedCpuTest__DOT__rst) {
        ...
        vlSelf->pipelinedCpuTest__DOT__dut__DOT__branchTargetEX = 0U;
        ...
        if ((((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__D_CACHE__DOT__m_read) 
            ...
            __Vdly__pipelinedCpuTest__DOT__dut__DOT__D_CACHE__DOT__mem__DOT__timer = 2U;
                        ...
                        ? ((2U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                            ? ((1U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                                ? ((vlSelf->pipelinedCpuTest__DOT__dut__DOT__ALUUnit__DOT__sum 
                                    >> 0x1fU) ? 1U : 0U)
                                : 0U) : 0U) : ((2U 
                                                & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
                                                ? vlSelf->pipelinedCpuTest__DOT__dut__DOT__ALUUnit__DOT__sum
                                                : (
                                                   (1U 
                                                    & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__AluCtrlEX))
    ...
    } else if ((1U & (~ (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_stall)))) {
        vlSelf->pipelinedCpuTest__DOT__dut__DOT__WBMEM 
            = vlSelf->pipelinedCpuTest__DOT__dut__DOT__WBEX;
        vlSelf->pipelinedCpuTest__DOT__dut__DOT__writeRegMEM 
            = ((0x10U & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__EXEX))
                ? (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__RdEX)
                : (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__RtEX));
    }
    ...
    if (vlSelf->pipelinedCpuTest__DOT__rst) {
        ...
        vlSelf->pipelinedCpuTest__DOT__dut__DOT__EXEX 
            = (0x1fU & (IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__finalCRLTID));
    }
    ...
    if (((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__IFflushEX) 
         | (IData)(vlSelf->pipelinedCpuTest__DOT__rst))) {
    ...
    if (vlSelf->pipelinedCpuTest__DOT__rst) {
        ...
        if (((IData)(vlSelf->pipelinedCpuTest__DOT__dut__DOT__ICACHE__DOT__m_read) 
            ...
            __Vdly__pipelinedCpuTest__DOT__dut__DOT__ICACHE__DOT__mem__DOT__timer = 2U;
