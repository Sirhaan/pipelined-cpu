...
VL_ATTR_COLD void VpipelinedCpuTest___024root___eval_static(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___eval_static\n"); );
}

VL_ATTR_COLD void VpipelinedCpuTest___024root___eval_final(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___eval_final\n"); );
}

#ifdef VL_DEBUG
VL_ATTR_COLD void VpipelinedCpuTest___024root___dump_triggers__stl(VpipelinedCpuTest___024root* vlSelf);
#endif  // VL_DEBUG
VL_ATTR_COLD bool VpipelinedCpuTest___024root___eval_phase__stl(VpipelinedCpuTest___024root* vlSelf);

VL_ATTR_COLD void VpipelinedCpuTest___024root___eval_settle(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___eval_settle\n"); );
    // Init
...
#endif
            VL_FATAL_MT("pipelinedCpuTest.sv", 3, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VpipelinedCpuTest___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void VpipelinedCpuTest___024root___dump_triggers__stl(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void VpipelinedCpuTest___024root___eval_stl(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
        VpipelinedCpuTest___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD bool VpipelinedCpuTest___024root___eval_phase__stl(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___eval_phase__stl\n"); );
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    VpipelinedCpuTest___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelf->__VstlTriggered.any();
    if (__VstlExecute) {
        VpipelinedCpuTest___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void VpipelinedCpuTest___024root___dump_triggers__act(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___dump_triggers__act\n"); );
    // Body
    if ((1U & (~ (IData)(vlSelf->__VactTriggered.any())))) {
        VL_DBG_MSGF("         No triggers active\n");
    }
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge pipelinedCpuTest.clk)\n");
    }
...
VL_ATTR_COLD void VpipelinedCpuTest___024root___dump_triggers__nba(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___dump_triggers__nba\n"); );
    // Body
    if ((1U & (~ (IData)(vlSelf->__VnbaTriggered.any())))) {
        VL_DBG_MSGF("         No triggers active\n");
    }
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge pipelinedCpuTest.clk)\n");
    }
...
VL_ATTR_COLD void VpipelinedCpuTest___024root___ctor_var_reset(VpipelinedCpuTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VpipelinedCpuTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VpipelinedCpuTest___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__branchTargetID = VL_RAND_RESET_I(32);
    ...
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__finalCRLTID = VL_RAND_RESET_I(10);
    ...
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__EXEX = VL_RAND_RESET_I(5);
    ...
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__branchTargetEX = VL_RAND_RESET_I(32);
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__pcSrcEX = VL_RAND_RESET_I(1);
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__IFflushEX = VL_RAND_RESET_I(1);
    ...
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__ic_stall = VL_RAND_RESET_I(1);
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_stall = VL_RAND_RESET_I(1);
    vlSelf->pipelinedCpuTest__DOT__dut__DOT__dc_done = VL_RAND_RESET_I(1);
    vlSelf->pipelinedCpuTest__DOT__dut__DOT____Vcellinp__D_CACHE__cpu_write = VL_RAND_RESET_I(1);
    vlSelf->pipelinedCpuTest__DOT__dut__DOT____Vcellinp__D_CACHE__cpu_read = VL_RAND_RESET_I(1);
