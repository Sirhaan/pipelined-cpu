...
VL_ATTR_COLD void VIcachecontroller___024unit___ctor_var_reset(VIcachecontroller___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VIcachecontroller__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+  VIcachecontroller___024unit___ctor_var_reset\n"); );
    // Body
